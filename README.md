...
2. [WebSocket API](#websocket-api)
   ...
   - [Message Format Specification](#message-format-specification)
     - [Initial State Message (Server → Client)](#initial-state-message-server--client)
     - [Operation Messages](#operation-messages)
       - [Client Input Format (Client → Server)](#client-input-format-client--server)
       - [Server Output Format (Server → All Clients)](#server-output-format-server--all-clients)
     - [Operation Types Details](#operation-types-details)
     - [Version Control and Conflict Resolution](#version-control-and-conflict-resolution)
     - [Error Handling](#error-handling)
   - [WebSocket API Usage Examples](#websocket-api-usage-examples)
     - [Complete Workflow Example](#complete-workflow-example)
     - [Multi-User Collaboration Example](#multi-user-collaboration-example)
   - [Client Implementation Guidelines](#client-implementation-guidelines)
     - [Connection Management](#connection-management)
     - [Operation Sending](#operation-sending)
3. [Core Concepts & Architectural Philosophy](#core-concepts--architectural-philosophy)
4. [Features](#features)
...
7. [Getting Started](#getting-started)
   ...
   - [Remote/Production Deployment Access](#remoteproduction-deployment-access)
8. [API Documentation (Swagger/OpenAPI)](#-api-documentation-swaggeropenapi)
   - [Viewing the Documentation](#-viewing-the-documentation)
   - [Documentation Files](#-documentation-files)
   - [What's Documented](#-whats-documented)
   - [Authentication in Documentation](#-authentication-in-documentation)
   - [Key Features](#-key-features)
   - [Using with Development Tools](#-using-with-development-tools)
   - [API Gateway Integration](#-api-gateway-integration)
   - [Testing with the Documentation](#-testing-with-the-documentation)
9. [Testing the System](#testing-the-system)
   ...
   - [WebSocket Real-Time Collaboration Testing](#websocket-real-time-collaboration-testing)
   - [Expected WebSocket Response Format](#expected-websocket-response-format)
   - [Troubleshooting WebSocket Connections](#troubleshooting-websocket-connections)
10. [Accessing the Observability Dashboard (Grafana)](#accessing-the-observability-dashboard-grafana)
    - [Grafana UI](#grafana-ui)
    - [View Logs from User Service](#view-logs-from-user-service)
    - [View Performance Metrics of User Service](#view-performance-metrics-of-user-service)
...
1. Uses a predefined SOURCE\_URL (update the URL in the script for your environment)
